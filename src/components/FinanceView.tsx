    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900/40 border border-white/5 rounded-2xl p-6 shadow-2xl relative group">
          ...
          <p className="text-3xl font-mono font-bold text-white tracking-tighter">{activeCases}</p>
          <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-2">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            {margins.map((m) => (
              <div
                key={m.patient_id}
                className="bg-slate-900/60 border border-white/5 p-4 rounded-xl flex justify-between items-center group hover:border-emerald-500/30 transition-all"
              >
                <div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            {accruals.map((a) => (
              <div
                key={a.employee_id}
                className="bg-slate-900/60 border border-white/5 p-4 rounded-xl flex justify-between items-center group hover:border-blue-500/30 transition-all"
              >
                ...
                <div className="text-right">
                  ...
                  <div className="flex flex-col items-end">
                    <p className="text-[8px] text-blue-400 uppercase font-black tracking-[0.2em]">
                      Net Accrued PKR
                    </p>
