          ...
          <div className="space-y-4">
            {LEDGER_DATA.map((row, i) => {
              ...
              return (
                <div
                  key={i}
                  className="p-4 bg-emerald-950/20 border border-emerald-500/20 rounded-xl relative"
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="text-white font-semibold">{row.patientName}</h3>
                      <p className="text-[10px] text-emerald-400/70 font-mono uppercase tracking-tighter">
                  ...
                  <div className="space-y-2">
                    {row.assignments.map((assignment, j) => (
                      <div
                        key={j}
                        className="flex items-center gap-3 p-3 bg-white/5 rounded-lg border border-white/5 group hover:border-emerald-500/30 transition-all"
                      >
        ...
        <div className="space-y-6">
          <div className="bg-slate-900/40 border border-white/5 rounded-xl p-6">
            ...
            <div className="space-y-8">
              ...
              <div className="pt-2">
                <p className="text-[10px] text-slate-500 uppercase tracking-widest mb-3 font-bold">
                  Policy Audit Checks
                </p>
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-3 rounded-lg bg-slate-800/50 border border-white/5">
                    <span className="text-[10px] text-slate-300 font-medium font-mono uppercase tracking-widest">
