          ...
          >
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h2 className="text-sm font-bold text-gray-800">Share Intake Form</h2>
              ...
              <button
                onClick={onClose}
                className="w-7 h-7 rounded-lg bg-gray-50/80 hover:bg-gray-100 flex items-center justify-center transition-colors"
              >
            ...
            {/* URL display */}
            <div className="bg-gray-50/80 border border-gray-200 rounded-xl px-4 py-3 mb-4">
              <p className="text-[10px] text-gray-500 uppercase tracking-wider font-medium mb-1">
                Intake Form URL
              </p>
              <p className="text-sm text-gray-600 font-mono truncate">{INTAKE_URL}</p>
            </div>
            ...
            <div className="flex gap-2">
              <button
                onClick={handleCopy}
                className="flex-1 flex items-center justify-center gap-2 bg-gray-50/80 hover:bg-gray-100 border border-gray-200 rounded-xl py-3 text-sm text-gray-800 font-medium transition-all"
              >
                {copied ? (
                  <>
